...
import antimattermod.core.Energy.MultiBlock.MultiControllerContainer;
import antimattermod.core.Energy.MultiBlock.MultiControllerGui;
...
public class AMMGuiHandler implements IGuiHandler {
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch (ID){
            ...
            case GuiID_MultiController: return new MultiControllerGui((MultiControllerTile)(world.getTileEntity(x, y, z)), world, player, x, y, z);
            default:return null;
        }
    }
}

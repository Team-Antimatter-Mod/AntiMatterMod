...
public class RecipeRegister {
    ...
    public static void RecipeRegisterInit(FMLInitializationEvent event){
        ...
        //ヤスリ
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(AntiMatterModRegistry.file_01,1,0),"  A"," AB","C  ",'A',OreDictionaryRegister.plateIron,'B',OreDictionaryRegister.craftingToolHardHammer,'C',"stickWood"));
